...
<div class="wrapper">
  <nav id="sidebar" class="sidebar d-flex flex-column collapsed">
    <div class="d-flex justify-content-between align-items-center text-white px-3 py-2 border-bottom">
      <span class="nav-label fw-bold">

        <div class="text-white mt-2 fw-semibold">{{ Auth::user()->name }}</div>
    ...
    <div class="text-center my-2">
      @if(Auth::user()->profile_picture)
        <img src="{{ asset('public/uploads/pics/' . Auth::user()->profile_picture) }}" alt="Profile Picture"
             class="rounded-circle" style="width: 50px; height: 50px; object-fit: cover;">
      @else
        <img src="{{ asset('public/uploads/pics/default.png') }}" alt="Default Profile Picture"
  ...
  <div class="content">
    ...
    <iframe id="contentFrame" src="{{ route('user.applicant.dashboard.overview') }}"></iframe>
  </div>
</div>
