        ...
        <form action="{{ route('jobs.apply.store', $job->slug) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    class="mt-1 block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                ...
                @foreach($job->questions as $q)
                    <div class="mb-5">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            {{ $q->question }} @if($q->required)<span class="text-red-500">*</span>@endif
                        </label>
                        <input
                            type="text"
                            name="answers[{{ $q->id }}]"
